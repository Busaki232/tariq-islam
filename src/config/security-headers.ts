...
export const SECURITY_HEADERS = {
  ...
  "Content-Security-Policy": [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://sunnah-api-production.up.railway.app https://challenges.cloudflare.com",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "font-src 'self' https://fonts.gstatic.com",
    "img-src 'self' data: https: blob:",
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://sunnah-api-production.up.railway.app https://challenges.cloudflare.com",
    "frame-src 'self' https://sunnah-api-production.up.railway.app https://challenges.cloudflare.com",
