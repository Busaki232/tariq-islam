...
const ScholarLecturesFeed = () => {
  ...
  {isActive && hasCaptionChoices && (
    <div className="absolute left-1/2 top-[42%] z-20 w-[calc(100%-5rem)] max-w-lg -translate-x-1/2 overflow-hidden rounded-xl border border-white/15 bg-black/75 text-white shadow-xl backdrop-blur-md">
