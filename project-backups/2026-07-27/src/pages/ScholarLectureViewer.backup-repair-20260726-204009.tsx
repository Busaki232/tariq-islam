...
const handleShare = async () => {
  ...
  return (
    ...
    sed -n '1415,1475p' src/pages/ScholarLectureViewer.tsx
    sed -n '1865,1925p' src/pages/ScholarLectureViewer.tsx
            swipeStartYRef.current = null;
                  ...
                  {relatedLectures.map((relatedLecture) => (
                    ...
                    >
                        ...
                        <video
                          src={
                            relatedLecture.thumbnail_url
                              ? relatedLecture.video_url
                              : `${relatedLecture.video_url}#t=0.001`
                          }
                      ...
                      <button
                        ...
                        onClick={() => {
                          navigate(
                            `/scholars/${relatedLecture.scholar_id}/lectures/${relatedLecture.id}`  {(event) => {
        const touch = event.touches[0];
    ...
    >
        ...
        <section className="px-4 pt-1 sm:px-1">
          ...
          {relatedLectures.length === 0 ? (
            ...
            <button
              type="button"
              className="relative block w-full overflow-hidden rounded-xl border bg-black shadow-sm"
              onClick={() => {
                videoRef.current?.pause();
              ...
              aria-label={relatedLecture.title}
            >
              {relatedLecture.thumbnail_url ? (
                <img
                ...
                <video
                  src={`${relatedLecture.video_url}#t=0.1`}
                  muted
                  playsInline
                  preload="metadata"
                  tabIndex={-1}
              ...
              <span className="absolute inset-0 flex items-center justify-center bg-black/10">
                <span className="flex h-14 w-14 items-center justify-center rounded-full bg-black/65 text-2xl text-white shadow-xl">
                  ▶
                </span>
              </span>
            </button>
