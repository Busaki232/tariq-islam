    ...
    <main className="min-h-screen scroll-smooth bg-background pb-24">
      <div className="mx-auto w-full max-w-5xl px-0 sm:px-4">
        ...
        <section className="relative bg-black sm:mt-2 sm:overflow-hidden sm:rounded-xl">
          ...
          {hasCaptionChoices && (
            <div className="absolute bottom-14 left-1/2 z-30 w-[calc(100%-32px)] max-w-2xl -translate-x-1/2">
              <div className="rounded-2xl border border-white/15 bg-black/75 p-3 text-white shadow-2xl backdrop-blur-md">
                <div className="flex justify-end">
                  ...
                  <select
                    ...
                    className="max-w-[190px] rounded-full border border-white/20 bg-black/70 px-3 py-1.5 text-xs font-semibold text-white shadow outline-none backdrop-blur-md"
                  >
                    <option value="off">
                      {t(
                ...
                {activeCaption && (
                  <p
                    ...
                    className="mt-2 text-center text-sm font-medium leading-relaxed text-white sm:text-base"
                  >
                    {activeCaption}
                  </p>
                )}
