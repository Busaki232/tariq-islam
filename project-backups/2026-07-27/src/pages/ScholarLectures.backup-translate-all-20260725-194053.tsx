...
const ScholarLectures = () => {
  ...
  const loadLectures = useCallback(
    async (showRefreshIndicator = false) => {
      ...
      try {
        ...
        setLectures((lectureData ?? []) as ScholarLecture[]);
      } catch (error: any) {
  ...
  const translateLectureCaptions = async (
    lecture: ScholarLecture
  ) => {
    if (
      generatingCaptionsLectureId ||
    ...
    const targetLanguageCode =
      selectedTranslationLanguage[lecture.id] || "ar";
    ...
    try {
      ...
      toast({
        title: t(
          "scholars.lectureManager.translationGenerated",
          { defaultValue: "Translation generated" }
        ),
        description: t(
          "scholars.lectureManager.translationGeneratedDescription",
          {
            language:
              selectedLanguage?.name ||
              targetLanguageCode,
            defaultValue:
              "{{language}} captions are now available.",
          }
        ),
      });
    } catch (error: any) {
      console.error(
        "Scholar lecture translation failed:",
        error
      );
      ...
      toast({
        ...
        description:
          ...
          t(
            ...
            {
              defaultValue:
                "The captions could not be translated.",
            }
          ),
        variant: "destructive",
      });
                ...
                <div className="space-y-2 rounded-xl border bg-muted/20 p-3">
                  ...
                  <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-2">
                    <select
                      ...
                      className="h-10 min-w-0 rounded-md border bg-background px-3 text-sm outline-none focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
                      aria-label={t(
                        "scholars.lectureManager.translationLanguage",
                        {
                          defaultValue:
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">
                        {t(
                          "scholars.lectureManager.translate",
