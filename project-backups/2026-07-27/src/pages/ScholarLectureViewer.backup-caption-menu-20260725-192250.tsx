          ...
          {hasCaptionChoices && (
            <div className="absolute left-3 top-3 z-30">
              <label
                ...
                className="sr-only"
              >
                {t("scholars.lectureViewer.captionLanguage", {
              ...
              <select
                ...
                className="max-w-[180px] rounded-full border border-white/20 bg-black/75 px-3 py-1.5 text-xs font-medium text-white shadow-lg outline-none backdrop-blur-md"
              >
                <option value="off">
                  {t("scholars.lectureViewer.captionsOff", {
