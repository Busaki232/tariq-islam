      ...
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden px-4 pb-48 pt-28">
        <div className="relative flex h-full w-full max-w-3xl items-center justify-center">
          {viewerVideoId ? (
            ...
            <div className="flex aspect-square w-[min(78vw,68vh)] max-w-[620px] flex-col items-center justify-center gap-4 rounded-full border-4 border-white/15 bg-neutral-950 text-center text-white">
              <Radio className="h-14 w-14 text-red-500" />

              <p className="text-xl font-semibold">Waiting for the scholar</p>

              <p className="max-w-xs px-8 text-sm text-white/60">
                The lecture will appear when the scholar begins broadcasting.
              </p>
            </div>
          )}
    ...
    return (
      <div className="flex min-h-[100dvh] items-center justify-center bg-black">
        <div className="flex flex-col items-center gap-4 px-6 text-center text-white">
          ...
          <div>
            <p className="text-lg font-semibold">Joining livestream…</p>

            <p className="mt-1 text-sm text-white/60">{livestream.title}</p>
          </div>
        </div>
      </div>
    );
