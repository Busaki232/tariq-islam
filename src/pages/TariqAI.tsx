...
import TariqTransformTool from "@/components/tariq-ai/TariqTransformTool";
...
type TariqAIMode = "chat" | "hajj" | "transform";
...
const TariqAI = () => {
  ...
  const submitQuestion = async (
    ...
    if (!isOnline) {
      setErrorMessage(
        "You are offline. The saved Hajj guide, checklist and duas remain available, but Tariq AI questions require an internet connection."
      );
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-background pb-28">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-xs text-muted-foreground">
                {mode === "hajj"
                    ...
                    : mode === "transform"
                      ? "Translate and summarize Islamic content"
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-col px-4 py-5">
        <div className="mb-5 grid grid-cols-3 gap-2 rounded-2xl border bg-muted/40 p-1.5">
          <button
            type="button"
          ...
          >
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1 rounded-xl px-2 py-2.5 text-xs font-medium transition sm:text-sm ${
                mode === "transform"
                  ? "bg-background text-foreground shadow-sm"
                  : "text-muted-foreground"
              }`}
          ...
          <section className="mb-4 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                  Your checklist, day-by-day guide, Quranic duas,
                  favorites and safety information remain available.
                  Reconnect to ask Tariq AI a live question.
                </p>
              </div>
            </div>
          </section>
        ...
        {mode === "transform" ? (
            <TariqTransformTool isOnline={isOnline} />
          ) : mode === "chat" ? (
...
<section className="mb-5 rounded-2xl border bg-card p-4">
        ...
        {mode !== "transform" && messages.length === 1 && (
          <section className="mb-5">
      ...
      <div
          className={
            mode === "transform"
              ? "hidden"
              : "fixed bottom-16 left-0 right-0 z-40 border-t bg-background/95 px-4 py-3 backdrop-blur md:bottom-0"
          }
        >
        <form
        ...
        >
          <textarea
            ...
            placeholder={
                !isOnline
                  ? "Offline — saved Hajj tools remain available"
                  : user
                    ? mode === "hajj"
